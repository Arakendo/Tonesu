...
This page is not claiming that Tonesu is an Arendtian language, that Arendt is the project's hidden master key, or that every later political distinction can be reduced to her work. The narrower claim is more interesting:

> once Tonesu began forcing hidden relations to stay visible, it repeatedly rediscovered a family of distinctions that Arendt also treated as structurally decisive.

The convergence is therefore worth documenting as a meta-level design result.
...
That is the point at which the overlap with Arendtian concerns becomes difficult to dismiss as coincidence.
...
- [Knowledge & claims](knowledge.md)
- [Predictive policing](predictive-policing.md)
- [Politics](domains/politics.md)
