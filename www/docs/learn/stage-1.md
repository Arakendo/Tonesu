...
Roots are introduced through sentences, in clusters of 3–6 per section. Reuse is heavy.
After completing this stage, you'll have encountered around 20 roots — not from a list,
but from having seen them work.

The [primitive inventory](../tonesu/primitives.md) exists as reference — consult it
when a root comes up, not as a study target.

---

## Cluster 1 — Acting and examining

These sentences come from C001 and C002 — engineers responding to equipment failure.
...
These sentences come from C001 and C002 — assessing two different pieces of failing
equipment. One engineer finds the relay unstable; another finds the connector broken.
...
These sentences are from C001 A2–B2 — a tightening deadline. A has found that the
...
These sentences come from C001, C003, and C004 — expressing what you know, what you
