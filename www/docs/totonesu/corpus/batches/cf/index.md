...
*Theme: [Grammar & syntax](../../grammar/overview.md)* · 9 sentences.
...
!!! annotation "Notes"
    ...
    - **Path A — what it costs:**
      1. *Mandatory first-person stance-holder (`la-mi`).* The speaker necessarily claims
         ...
         — always an explicit attributor. This reflects Tonesu epistemic culture: every
...
!!! annotation "Notes"
    ...
    - **Path A — social domain problem exposed:** The counterfactual here is not primarily
      ...
      natural Tonesu form would attribute this differently: to the investigation body,
    ...
    - **Cultural note:** This may not be a bug. Tonesu epistemic culture insists that
      ...
      counterfactuals in Tonesu discourse are always testimony, not neutral logic.
