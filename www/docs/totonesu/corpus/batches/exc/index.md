...
!!! annotation "Notes"
    Testing whether `ru` in the inter-argument position (after agent NP, before predicate) functions as an exclusive focus particle. **Two competing parses:**
