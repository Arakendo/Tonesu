...
Definition:   informal stub for "pack-social acoustic organism" — the canid class in
              casual discourse. Covers any organism whose formal kind-term uses
              zo-se-so-li as its base. In everyday speech, identifies dog, wolf, coyote,
              jackal, and all zo-se-so-li kind-terms.
Compression:  zo (organism anchor) + [se-so dropped — acoustic-organism qualifiers
              contextually recoverable] + li (pack-social agency root) → zol.
              The se-so middle is the acoustic-organism narrowing; it is recoverable
              in any discourse context where pack animals are the topic. The terminal
              root li (pack-social orientation) is the class-distinguishing element and
              is retained.
...
Type:         contraction / colloquial stub
Class:        entity (organism kind)
Definition:   informal stub for "territorial-boundary acoustic organism" — the felid/fox
              class in casual discourse. Covers any organism whose formal kind-term uses
              zo-se-so-fe as its base. In everyday speech, identifies house cat, lion,
              tiger, leopard, jaguar, puma, fox, and all zo-se-so-fe kind-terms.
Compression:  zo (organism anchor) + [se-so dropped — acoustic-organism qualifiers
              contextually recoverable] + fe (territorial-boundary orientation root) →
              zof. Symmetric with zol.
Register:     colloquial / casual spoken
Domain:       general
Status:       active
