...
| [w101-plus.md](w101-plus.md) | W101–W149 | 49 (2 retired) |

**Total: 136 W-series entries** — active: 114 · proposed: 7 · cold: 2 · accepted: 2 · retired: 2

Status key: ✅ active/accepted · ⚠️ proposed · ❄️ cold · 🚫 retired
...
| `fa-wi-zi` | W136 | lust, affect-desire-to-couple | ⚠️ | [w101-plus](w101-plus.md) |
...
| `ra-ki` | W038 | storm, kinetic-force discharge | ⚠️ | [w001-w050](w001-w050.md) |
...
| `si-ne-ki` | W021 | signal-transmission process | ❄️ | [w001-w050](w001-w050.md) |
...
| `su-ti` | W101 | current state, instantaneous configuration | ❄️ | [w101-plus](w101-plus.md) |
...
| `to-ki-mu` | W011 | computer, calculator | ⚠️ | [w001-w050](w001-w050.md) |
...
| `zi-ka` | W105 | transaction, intentional exchange event | ⚠️ | [w101-plus](w101-plus.md) |
| `zi-ra` | W104 | physical interaction, mutual energy transfer | ⚠️ | [w101-plus](w101-plus.md) |
| `zi-zo` | W106 | biological coupling event | ⚠️ | [w101-plus](w101-plus.md) |
...
**Person / Agent**
`li-su-li` W001 leader · `su-mu-li` W002 engineer · `to-li` W003 scholar · `li-be` W033 child (developmental) · `to-fe-li` W032 epistemic guardian · `di-ki-li` W061 navigator · `si-no-vo-li` W126 hypocrite · `wi-de-li` W124 adversary/enemy · `zo-li` W148 human person
...
**Place / Space**
`li-pu-pa` W036 city · `ko-pa` W048 room · `ki-pa` W049 corridor · `pa-ra` W053 energetic field · `pa-wi-ka-su` W066 shrine · `pa-wi` W088 destination · `pa-mi` W110 here (deictic) · `pa-be'ka-li-su` W125 kingdom of heaven · `pa-fe` W138 vault/sky-dome · `pa-zo-li` W135 the world / inhabited realm

**Artifact / Device**
`to-su-mu` W010 database · `to-ki-mu` W011 computer · `ra-ki-mu` W012 engine · `ka-mu` W047 tool · `si-mu` W039 relay device · `ko-mu` W052 container · `si-ko-mu` W067 document · `ki-pa-mu` W086 vehicle · `ma-no-de` W046 medicine · `wi-to` W045 plan · `vo-mu` W137 clothing/garment
...
**Knowledge / Epistemic**
`to-ne-su` W000 truth · `to-su` W030 theory/model · `to-ki` W020 reasoning · `to-ko` W027 memory · `to-si` W026 query/proposition · `to-su-ki` W025 comprehend · `to-su-mu` W010 database · `to-ru` W083 consensus · `to-fe` W028 epistemic boundary · `to-fe-ka` W029 mislabeling · `to-fe-li` W032 adjudicator · `to-fe-su` W072 standards body · `to-fe-su-ki` W097 ruling → public · `to-go` W089 counterfactual frame · `to-re-su` W064 scripture · `ka-to-fe` W122 act of judging
...
`fa-ki` W093 shift · `fa-de` W094 fading · `fa-no` W095 inactive · `fa-re` W096 cycling · `se-no-to` W090 unresolved percept · `fa-ra-be` W123 anger · `fa-wi-de` W127 temptation · `su-fa` W133 purity of heart · `wi-no-ra` W132 meekness · `fa-wi-zi` W136 lust

**Ritual / Sacred**
`wi-ka-su` W054 ritual · `fe-vo` W065 sacredness · `pa-wi-ka-su` W066 shrine · `wi-si` W063 prayer · `to-re-su` W064 scripture · `zo-to` W068 soul · `zo-si` W069 spirit · `fe-no-ka` W056 taboo · `se-to` W062 vision/insight · `zo-ra` W117 life-energy · `vo-ne` W118 righteousness · `pa-be'ka-li-su` W125 kingdom of heaven · `be-go-li-si` W149 creator-representation/image · `ka-li-su` W147 governance/dominion

**Social / Institutional**
`ne-su` W031 network/society · `ne-to` W084 agreement · `to-fe-su` W072 standards body · `wi-fe` W100 rule/prohibition · `wi-re-su` W074 protocol · `wi-to-su` W073 specification · `wi-re` W099 feedback loop · `li-pu-pa` W036 city · `si-no-vo-li` W126 hypocrite · `wi-de-li` W124 adversary · `ne-zi-re` W131 spouse · `ka-no-de-su` W120 forgiveness · `de-su` W119 fault/wrong · `de-vo` W121 evil · `re-ka-ne-li` W134 peacemaker · `ka-li-su` W147 governance/dominion

**Organism / Biology**
`zo-de` W051 fatigue · `zo-no-ki` W043 sleep · `zo-se-ki` W060 trance · `zi-zo` W106 coupling event · `zi-zo-go` W107 go-role · `zi-zo-du` W108 du-role · `zo-to` W068 soul · `zo-si` W069 spirit · `zo-ra` W117 life-energy · `ka-de-zo` W128 to kill · `se-lu` W130 eye · `zo-li` W148 human person · `wi-zo` W145 wild animal · `ma-zo-ki` W146 crawler · `du-zo-su` W142 fruit · `zo-su-be` W143 seed · `zo-ra-ma` W144 food

**Energy / Matter / Physics**
`ra-ki` W038 storm · `ra-ki-mu` W012 engine · `ra-ma` W082 fuel · `ra-vo` W071 intensity · `pa-ra` W053 field · `ne-ra` W058 resonance state · `ne-ra-ki` W059 attune · `zi-ra` W104 physical interaction · `ha-de` W044 cooling · `su'ma` W113 solid · `ki'ma` W114 liquid · `no-su'ma` W115 gas · `ma-ra` W116 plasma · `nu-se` W102 measurement · `lu-mu` W139 light-body
...
|-----------|-----------------|
| `de` | de-be W035, de-su W119, de-vo W121 |
| `be` | be-go-li-si W149 |
| `di` | di-ki-li W061 |
| `du` | du-zo-su W142 |
| `fa` | fa-ki W093, fa-de W094, fa-no W095, fa-re W096, fa-ra-be W123, fa-wi-de W127, fa-wi-zi W136 |
| `fe` | fe-si W024, fe-su W055, fe-no-ka W056, fe-vo W065 |
| `ha` | ha-de W044 |
| `ka` | ka-mu W047, ka-ne-de W092, ka-to-fe W122, ka-de-zo W128, ka-no-de-su W120, ka-li-su W147 |
| `ki` | ki-pa W049, ki-pa-mu W086, ki'ma W114 |
...
| `mu` | mu-ka W022 |
| `ne` | ne-fe W042, ne-su W031, ne-ra W058, ne-ra-ki W059, ne-to W084, ne-de W091, ne-zi-re W131 |
| `no` | no-ne-fe W075, no-su'ma W115, no-de-ma W129, no-lu-ti W141 |
| `nu` | nu-se W102 |
| `re` | re-ka-ne-li W134 |
| `pa` | pa-nu W050, pa-ra W053, pa-wi W088, pa-wi-ka-su W066, pa-ki W087, pa-mi W110, pa-be'ka-li-su W125, pa-fe W138, pa-zo-li W135 |
| `ra` | ra-ki-mu W012, ra-ki W038, ra-vo W071, ra-ma W082 |
| `se` | se-ka W034, se-to W062, se-no-to W090, se-lu W130 |
| `si` | si-ki W023, si-mu W039, si-fe W070, si-ko-mu W067, si-de W098, si-ne-ki W021, si-no-vo-li W126 |
...
| `to` | to-ne-su W000, to-li W003, to-ki-mu W011, to-ki W020, to-si W026, to-ko W027, to-fe W028, to-fe-ka W029, to-su W030, to-fe-li W032, to-su-ki W025, to-su-mu W010, to-re-su W064, to-fe-su W072, to-go W089, to-ru W083, to-fe-su-ki W097 |
...
| `zo` | zo-no-ki W043, zo-de W051, zo-se-ki W060, zo-to W068, zo-si W069, zo-ne W076, zo-ne-go W077, zo-ne-du W078, zo-ne-ru W079, zo-ne-go-re W080, zo-ne-du-re W081, zo-ra W117, zo-li W148, zo-ra-ma W144, zo-su-be W143 |
