...
> save-life → lose-life
> lose-life-for-purpose → find-life
...
| Form | Reading | Source |
|------|---------|--------|
| `zo-ra` | life-energy / ψυχή | W117; established GOD-RES/S359 |
| `ka-no-de` | deliberate preservation / acts to prevent decay | `ka` (deliberate action) + `no-de` (preservation) = act-of-preservation; compositional |
| `wi-mi` | for my sake / for my purpose | `wi` (will/purpose root) + `mi` (first person) = my-purpose / for-my-sake; compositional; purpose-frame compound used as a directional modifier |
...
```
go  la-ze  ka-no-de  lo-zo-ra-ze  /  lo-zo-ra-ze  de
```
...
```
go  la-ze  ka-de  lo-zo-ra-ze  wi-mi  /  lo-zo-ra-ze  be
```
...
**Written:**
```
go laze kanode lozoraze / lozoraze de //
go laze kade lozoraze wimi / lozoraze be
```
...
|--------|---------|-----------------|--------|
| S459 | preserve life (`ka-no-de lo-zo-ra-ze`) | `go / de` | life decays |
| S460 | surrender life (`ka-de lo-zo-ra-ze wi-mi`) | `go / be` | life grows |
...
| Entry | Form | Key test |
|-------|------|---------|
| MTH-001-A (S459) | `go laze kanode lozoraze / lozoraze de` | Causal inversion; preservation → decay |
| MTH-001-B (S460) | `go laze kade lozoraze wimi / lozoraze be` | `ka-de` deliberate sacrifice; `wi-mi` telic-for-purpose; surrender → growth |
