...
## SLZ-002 — The Mutual Knowledge Structure

**Source:** Attributed to Alexander Solzhenitsyn (attribution contested; captures the epistemic structure he describes throughout his Soviet-era works, especially *The First Circle* and *The Gulag Archipelago*). The specific formulation: "We know that they are lying, they know that they are lying, they know that we know that they are lying, we know that they know that we know they are lying, and still they continue to lie."

**Epistemic core:** This batch extends SLZ-001's `to-fe-ka` framework into **iterated mutual knowledge** — the distinctive feature of Soviet institutional lying. The puzzle: all parties know the fraud is fraud. No deception is occurring. Yet the performance of belief continues to be demanded and supplied. This resolves to a structural insight: the demand in this context is not for `si-no` (false-signal / deception, which requires target ignorance) but for the public act of `ka-to-fe-ka` despite full mutual awareness. The lie is not a communication of false belief — it is a demonstration of power over the co-signer's will.
...
**Tonesu:** `la-mi  to  [la-ze  to-fe-ka] / la-ze  to  [la-ze  to-fe-ka]`
...
**Notes:** Base parallel establishing symmetric first-level knowledge. `la-mi to [la-ze to-fe-ka]` = personal epistemic modal (`to` = knowledge) with clausal bracket: I know [that-they commit fraud]. `la-ze to [la-ze to-fe-ka]` = they know [that they themselves commit fraud] — the agent `la-ze` appears in both the outer frame and the inner bracket, marking the self-knowledge of the perpetrators. `/` = bi-clausal parallel: the two knowledge claims are structurally paired as the symmetric foundation for the nesting in S773. **First use of `to [CLAUSE]` in a `/` bi-clausal parallel construction.** Note the distinction from S767 (SLZ-001-C) where `si` and `no-to` were the paired modals: here both sides of `/` carry the same modal (`to`) with different agents.
...
**Tonesu:** `la-ze  to  [la-mi  to  [la-ze  to-fe-ka]] / la-mi  to  [la-ze  to  [la-mi  to  [la-ze  to-fe-ka]]]`
...
**Natural reading:** They know that I know that they are committing fraud / I know that they know that I know they are committing fraud.

**Notes:** **First iterated epistemic nesting at depth 3 and depth 4 in the running corpus.** The left clause of `/` is depth 3: `la-ze to [la-mi to [la-ze to-fe-ka]]` = they know [I know [they commit fraud]]. The right clause is depth 4: `la-mi to [la-ze to [la-mi to [la-ze to-fe-ka]]]` = I know [they know [I know [they commit fraud]]]. Brackets handle the depth unambiguously — each `[` opens a new clausal scope. The alternating `la-ze` / `la-mi` agents inside the nested brackets track whose knowledge is being indexed at each level. Parse invariants hold: every internal syllable begins with a consonant; compound boundaries are visible; bracket depth is marked by `[]`. The structural observation: at this depth the knowledge is informationally redundant — both parties have had full mutual knowledge since depth 1 (S772). The addition of depth 3 and 4 adds no new information. Its social function is performed, not informational.
...
**Tonesu:** `la-a-li  to  [la-ze  to-fe-ka] — la-ze  [ka-to-fe-ka]  re`

**Written:** `laali to [laze tofeka] — laze [katofeka] re`

**Gloss:** all-persons know [they commit-fraud] — they [commit-fraud] cyclically

**Natural reading:** All persons know that they are committing fraud — and yet they continue committing it.

**Notes:** `la-a-li` = `a-` (universal/abstract scope prefix) + `li` (person) = all-persons — **first use of `a-li` as a universal quantified agent NP**. This extends the `a-` prefix from abstract-attribute scope (SLZ-001 S765: `a-to-fe-ka`, `a-ne-su`) to NP quantification: `a-li` = every person / the universal set of persons. `to [la-ze to-fe-ka]` = know [that they commit fraud] — propositional knowledge claim as established. `—` = prosodic suspension marking the contrast before the continuation clause. `la-ze [ka-to-fe-ka] re` = they [commit-fraud] cyclically: `re` (primitive: repetition/cycle) used **for the first time as a post-verbal aspectual modifier** meaning "continue/repeatedly." Position mirrors `ti-de` (sentence-final temporal modifier): `la-ze [ka-to-fe-ka] re` = they [commit-fraud] + cyclically = they continue committing fraud. Universal knowledge of the fraud (`la-a-li to`) and the continuation of the fraud (`la-ze [ka-to-fe-ka] re`) are placed in tension by `—`: the suspension holds the paradox open rather than resolving it.

---

### S775 — SLZ-002-D

**Source:** The structural insight — the demand is for performance, not belief.

**Tonesu:** `la-ze  wi-ra  no  [si-no] / la-ze  wi-ra  [la-o-li  ka-to-fe-ka]`
...
**Notes:** Antithetical `/` parallel resolving the paradox of S774. `la-ze wi-ra no [si-no]` = they demand not [false-signaling/deception]: `wi-ra` (W177, directed-will/demand) takes a negated clausal argument `no [si-no]`. `si-no` = false-signal (compositional: `si` signal + `no` negation = outward signal of a false state = deception); established in SNG-001 (`ka-si-no` = to lie). The demand is explicitly *not* for `si-no` — which requires the target to not know the signal is false. `/` = structural midpoint of the antithetical pair. `la-ze wi-ra [la-o-li ka-to-fe-ka]` = they demand [that the collective commits fraud]: `la-o-li` = collective-persons (established SLZ-001 S766) as the required agents of the act. The structural distinction `si-no` (deception = false signal requiring target ignorance) vs `ka-to-fe-ka` (epistemic fraud = deliberate boundary violation regardless of mutual knowledge) is here made explicit: you cannot deceive someone who already knows. What is demanded instead is the public act of boundary-crossing. **First explicit contrast between `si-no` and `ka-to-fe-ka` as distinct epistemic violation types.**

---

### S776 — SLZ-002-E

**Source:** The conclusion — universally-known fraud is an exercise of power.

**Tonesu:** `[a-li  to]  to-fe-ka  ne  wi-ra`
...
**Notes:** **First bracketed-modifier + nominal `ne` predicate structure with `wi-ra` as property.** `[a-li to]` = modifier bracket: "universally-known" — `a-li` (all-persons) + `to` (know) = the property of being universally known. Modifier-before-head (standard Tonesu order): the bracket modifies `to-fe-ka` (W029, epistemic fraud). So the subject is: "[universally-known] fraud" — the specific category of fraud that operates under full mutual awareness. `ne` = copula (property attribution). `wi-ra` (W177, directed will / demand / authority) as the property: this kind of fraud *is* directed power. The claim is not that fraud equals power in general (`helms` would be required), but that `[a-li to] to-fe-ka` *has the property of* `wi-ra`. Structural argument: if all parties already know the fraud is fraud, then no epistemic boundary violation in the sense of *causing false belief* is occurring. What is occurring is `wi-ra` — the imposition of will through the demand for public performance. S775 showed what is *not* demanded (deception); S776 names what *is*: power over the co-signer's voice.
...
| Entry | Tonesu | Written | Claim | Key feature |
|-------|--------|---------|-------|-------------|
| S772 (SLZ-002-A) | `la-mi  to  [la-ze  to-fe-ka] / la-ze  to  [la-ze  to-fe-ka]` | `lami to [laze tofeka] / laze to [laze tofeka]` | I know / they know (first parallel) | `to [CLAUSE]` in `/` bi-clausal parallel (first) |
| S773 (SLZ-002-B) | `la-ze  to  [la-mi  to  [la-ze  to-fe-ka]] / la-mi  to  [la-ze  to  [la-mi  to  [la-ze  to-fe-ka]]]` | `laze to [lami to [laze tofeka]] / lami to [laze to [lami to [laze tofeka]]]` | They know I know / I know they know I know | Iterated epistemic nesting depth 3 + 4 (first) |
| S774 (SLZ-002-C) | `la-a-li  to  [la-ze  to-fe-ka] — la-ze  [ka-to-fe-ka]  re` | `laali to [laze tofeka] — laze [katofeka] re` | All know — they continue anyway | `a-li` universal agent (first); `re` post-verbal aspectual modifier (first) |
...
| S776 (SLZ-002-E) | `[a-li  to]  to-fe-ka  ne  wi-ra` | `[alito] tofeka ne wira` | Universally-known fraud is directed power | Bracketed modifier on nominal subject; `wi-ra` as `ne`-predicate property |

**New vocabulary:** none (all forms compositional from registered entries).

**Compositional first uses:** `a-li` (universal quantified agent, `a-` + `li`); `re` as post-verbal aspectual modifier (continuation/cycle sense).

**Key structural findings:**
1. **Iterated epistemic nesting depth 3 and 4** (S773). First in running corpus. Brackets handle depth unambiguously; alternating `la-ze`/`la-mi` agents track whose knowledge is indexed at each level. The depth adds no new information content — its function is performed, not epistemic.
2. **`a-li` as universal quantified agent** (S774). First use of `a-` scope prefix on `li` (person) to create a universal NP subject: "all persons." Extends `a-` from attribute-scope (SLZ-001) to NP quantification.
3. **`re` as post-verbal aspectual modifier** (S774). First aspectual use of the repetition/cycle primitive in sentence-final position. Pattern mirrors `ti-de` temporal: `la-X [VERB] re` = X does VERB cyclically/repeatedly.
4. **`si-no` vs `ka-to-fe-ka` explicit contrast** (S775). First sentence that names the difference: deception requires target ignorance; epistemic fraud does not. The demand under mutual knowledge is not for `si-no` but for `ka-to-fe-ka`.
5. **Universally-known fraud as power** (S776). `[a-li to] to-fe-ka ne wi-ra`: the category of fraud that operates under full mutual knowledge is a property-attribution of `wi-ra` (directed will/power). The lie in this context is not epistemic but political — a demonstration of the power to compel performance regardless of what all parties know.
...
| Form used | CLQ entry | Colloquial form | Notes |
|-----------|-----------|-----------------|-------|
| `to [CLAUSE]` | none | — | Epistemic modal — semantically load-bearing; relaxation changes grade |
| `a-li` | none | — | Scope-prefix form — grammatical operator; outside CLQ scope |
| `la-a-li` | none | — | Scope-prefix NP — grammatical operator; outside CLQ scope |
| `to-fe-ka` (W029) | none | — | 3-root — below 4-morpheme contraction threshold |
| `ka-to-fe-ka` | none | — | 4-root verbal compound — defer CLQ pending further attestations (see SLZ-001 CLQ note) |
| `wi-ra` (W177) | none | — | 2-root — below threshold |
...
**Notes:** `si-ne-su` (W237) first use. `ne-fe` (W042) encodes the structural-role reading of "serve as" — the media's function is a built-in structural requirement. `si lo-o-li` = signal to the collective = communicate to the general populace. `;` then `ka-be lo-to-su ko {o-li}` = deliberately construct organized-knowledge within [the collective] = inculcate values. `ko {o-li}` as locative frame parallels the established `ki ko {}` motion-within-containment pattern (MAO S809). The two structural roles: communicate (surface) and install beliefs (deep).

---

### S836 — MCH-001-B

**Source:** "The propaganda model traces the routes by which money and power are able to filter the news fit to print, marginalize dissent, and allow the government and dominant private interests to get their message across to the public." — Chapter 1 (close paraphrase)
...
**Notes:** `si-ne-su'si-fe` = [media]-signal-threshold = media-filter. Juncture `'` pre-binds `si-ne-su` (W237) as a unit modifying `si-fe` (W070, signal threshold); without juncture, `si-ne-su-si-fe` right-branches incorrectly as `si + [ne-su-si-fe]`. `si-fe` (W070) reused in propaganda-model register as "filter" — the threshold that determines what signals pass through. First application of `si-fe` to the mass media domain; previously established in measurement/physics contexts (S067). `la-wi-ra ka-be` = directed-power deliberately-constructs = power actively builds the filter system. The filter is not natural; it is constructed by power.

---

### S837 — MCH-001-C

**Source:** Walter Lippmann's phrase "the manufacture of consent," adopted by Chomsky & Herman as the book's organizing concept — the systematic production of public agreement with dominant institutional arrangements.
...
**Notes:** `wi-o-li` (W238) first use. Right-branching: `wi` + `[o-li]` = will of [collective-persons] = the organized will of the collective = consent / public opinion. `ka lo-wi-o-li` = deliberate production of collective will = manufacturing consent. `la-wi-ra` = directed-power as institutional agent. Four morphemes encode the title concept with full compositional transparency: what is manufactured (`wi-o-li`), how (`ka`), and by whom (`la-wi-ra`).

---

### S838 — MCH-001-D

**Source:** "Worthy victims are those whose pain and suffering are given prominent coverage and whose deaths elicit great concern; unworthy victims receive little attention." — Chapter 2, paraphrase of the organizing distinction
...
**Notes:** `vo-de-zo-li` = good-suffering-person = worthy victim; first use. `no-vo-de-zo-li` = not-good-suffering-person = unworthy victim; first use. Right-branching: `vo` modifies `[de-zo-li]` = goodness-of [suffering-person]. The `/` marks the parallel construction: the same deliberate act (`ka-be`) produces two categories. Chomsky's argument is that "worth" is not inherent to victims but *constructed* by the media — `ka-be` encodes this. Agent `la-si-ne-su` carries through to both arms.

---

### S839 — MCH-001-E

**Source:** Paraphrase of the spectrum thesis — power strictly limits which topics may be addressed (the outer boundary), while permitting vigorous debate within that constrained range (the inner motion), creating the appearance of free discourse.
...
**Notes:** `to-su-fe` = organized-knowledge-boundary = the limiting edge of acceptable discourse = the spectrum limit; first use. `to-su-ki` = organized-knowledge-motion = movement within the discourse space = debate and discussion; first use. `ka-fe` = deliberate boundary-imposition; first systematic predicate use of `ka + fe`. `no-ka-fe` = does not constrain. The `;` is Humean conjunction: both facts are stated without asserting that one causes the other. The structural encoding of the spectrum argument: power bounds the outer limit AND leaves inner debate free as a legitimizing appearance.
...
**Notes:** `ne-ra-ki` (W059) = resonance-attunement inchoative = to enter mutual-modification coupling. Previously in the resonance/mecha domain (S083) and physics. MCH-001 transfers it to political economy: the "symbiotic relationship" between media and powerful sources is structurally identical to resonant coupling — both parties are modified by the relation. `ne-ra-ki` asserts mutual transformation, not one-way dependence. `lo-wi-ra` = patient: directed-power = the institutional power sources. First cross-domain application of `ne-ra-ki` to political-economic register; `ne-ra-ki` confirmed as domain-general.
...
**Notes:** `ra-si` = force-signal = signal deployed with and as force = organized criticism / flak; first use. `ka-ra-si` = deliberate force-signal = the institutionally-deployed attack-signal. Right-branching: `ka` + `[ra-si]` = deliberately [force-signal]. Distinct from bare `si` (signal) and bare `ra` (force): `ra-si` specifically names force expressed *through* signaling — criticism, litigation, political pressure — all signals carrying force. `lo-si-ne-su` = patient: the media system. The filter mechanism: flak disciplines media coverage by deploying attack-signals against it whenever coverage challenges institutional interests.

---

### S842 — MCH-001-H

**Source:** "Anticommunism as a religion and control mechanism." — Chapter 1 (the fifth filter, generalized): prevailing ideology functions as a filter constructing what the media may and may not say.
...
**Notes:** Structural parallel with S836: both `la-wi-ra` (power) and `la-to-su-ra` (doctrine-force) `ka-be lo-si-ne-su'si-fe` (build the media's filters). The parallelism encodes the propaganda model's multi-filter argument: economic power and ideological coercion are both filter-builders on the same system. `to-su-ra` = doctrine-force = prevailing ideology as coercive structural force; standalone first use (ORD-001 established `to-su-ra-li` = ideological fanatic; here `to-su-ra` without `-li` names the ideology-as-force rather than the person embodying it). Agent: `la-to-su-ra` = ideology acting as institutional agent.

---

### S843 — MCH-001-I

**Source:** "Views that are inconvenient to the powerful are simply absent from the mainstream media, or appear only in marginal form." — paraphrase of the marginalization thesis (Chapters 1–5)
...
**Notes:** `si-no-su` = signal-not-structure = counter-structural signal = a signal that falls outside or challenges the established structural order = dissent voice; first use. Right-branching: `si` + `[no-su]` = signal of [not-structure]. Distinct from `ka-ne-su` (ORW-001 S821, revolt = deliberate action against structure) — `si-no-su` is a signal, not an action; it names the voice, not the revolt. `no-si lo-si-no-su` = does not signal [about] dissent-signals = does not cover or transmit dissenting voices. No active suppression claimed — only absence of transmission, consistent with S844's non-conspiracy framing.
...
**Notes:** `ne-ki` = relation-inchoative = to enter coordination = to conspire/collude. `no [la-wi-ra ne-ki]` = not [power coordinates] = denies the conspiracy model using clause negation. `su-ra` = structure-force = the force inherent in structural arrangement, independent of deliberate coordination; first use. `go {su-ra}` = from [structural force] = by the compulsion of how the system is structured. `la-wi-ra ra lo-si-ne-su` = directed-power forces-over the media = power dominates the media structurally. The `/` partitions the authors' two simultaneous claims: deny conspiracy / assert structural mechanism. Fifth use of the "not-X / but-Y" `/` pattern (previous: MAO S802, S807; ORW S818; ORD S833). First use of `no [clause]` in the left arm of a `/` construction; first use of `go {}` in the right arm of a "not-X / but-Y" structure.
...
| S# | Quote / Claim | Core notation | Structural notes |
|----|---------------|---------------|------------------|
| S835 | Media's structural function | `sinesu nefe si looli ; kabe lotosu ko {oli}` | `si-ne-su` (W237) first use; `ko {}` as locative frame |
| S836 | Power builds filters | `lawira kabe losinesu'sife` | `si-ne-su'si-fe` juncture; `si-fe` (W070) cross-domain |
| S837 | Manufacturing consent | `lawira ka lowioli` | `wi-o-li` (W238) first use; four-morpheme title concept |
| S838 | Worthy/unworthy victims | `lasinesu kabe lovodezoli / kabe lonovodezoli` | `vo-de-zo-li`/`no-vo-de-zo-li` first uses; parallel `/` |
| S839 | Spectrum of acceptable opinion | `lawira kafe lotosufe ; nokafe lotosuki` | `to-su-fe`/`to-su-ki` first uses; `ka-fe` first predicate use |
| S840 | Media-power symbiosis | `lasinesu neraki lowira` | `ne-ra-ki` (W059) first political-economy application |
| S841 | Flak filter | `lawira karasi losinesu` | `ra-si` (force-signal/flak) first use |
| S842 | Ideology as filter | `latosura kabe losinesu'sife` | Structural parallel with S836; `to-su-ra` standalone first use |
| S843 | Marginalization of dissent | `lasinesu nosi losinosu` | `si-no-su` (dissent voice) first use |
| S844 | Structure not conspiracy | `no [lawira neki] / go {sura}, lawira ra losinesu` | `su-ra` first use; `no [clause]` in `/` left arm; 5th "not-X/but-Y" |

**New W-entries:** W237 `si-ne-su` = media institution / signal-network-structure · W238 `wi-o-li` = collective will / consent.

**Compositional first uses:** `si-ne-su'si-fe` (media-filter, S836, S842); `vo-de-zo-li` (worthy victim, S838); `no-vo-de-zo-li` (unworthy victim, S838); `to-su-fe` (discourse boundary/spectrum limit, S839); `to-su-ki` (discourse motion/debate, S839); `ka-fe` (deliberate boundary-imposition, S839); `ra-si` (force-signal/flak, S841); `to-su-ra` (doctrine-force standalone, S842); `si-no-su` (dissent voice, S843); `su-ra` (structural force, S844).
...
| Form used | CLQ entry | Colloquial form | Notes |
|-----------|-----------|-----------------|-------|
| `si-ne-su` (W237) | none | — | 3-root first use; defer |
| `wi-o-li` (W238) | none | — | 3-morpheme first use (wi + o-prefix + li); defer |
| `si-fe` (W070) | none | — | 2-root — below CLQ threshold |
| `wi-ra` (W177) | none | — | 2-root — below CLQ threshold |
| `to-su` (W030) | none | — | 2-root — below CLQ threshold |
| `ne-ra-ki` (W059) | none | — | 3-root — meets threshold; cross-register use; no new shortform |
| `si-ne-su'si-fe` | none | — | 4-morpheme juncture compound first use; defer |
| `vo-de-zo-li` | none | — | 4-root first use; defer |
| `no-vo-de-zo-li` | none | — | 5-root first use; defer |
| `to-su-fe` | none | — | 3-root first use; defer |
| `to-su-ki` | none | — | 3-root first use; defer |
| `ka-fe` | none | — | 2-root — below CLQ threshold |
| `ra-si` | none | — | 2-root — below CLQ threshold |
| `to-su-ra` | none | — | 3-root standalone first use; defer |
| `si-no-su` | none | — | 3-root first use; defer |
...
## ANT-002 — Hannah Arendt, *The Origins of Totalitarianism* — continued (S855–S864)

**Purpose:** Second pass on Arendt's *Origins*. Covers: camp as juridical rightless space; ideology+terror as twin pillars; masses vs. organized classes; the "everything is possible" claim; nation-state decline → statelessness; historical necessity displacing collective will; secret police as inner core; propaganda vs. reasoning; natality as antidote; politics as space of living-person plurality.
...
**Natural reading:** "Totalitarianism destroys the limits of the possible — everything can be done."
...
**Natural reading:** "Because the nation-state declined, stateless persons came to exist."

**Notes:** Arendt's historical argument: statelessness was produced by the systemic breakdown of the nation-state — the political form that tied rights to national belonging. When nation-states collapsed or stripped citizenship from groups, those people fell through the floor of the international system because no other institution existed to guarantee rights. `na-ne-su` = identity-network-structure = the nation-state: `na` (individual identity) + `ne-su` (W031). `ki lo-de` = moves toward decay = declines (motion-toward-patient frame). `la-no-ne-su-li be` = stateless persons come-to-be: intransitive `be` = begins to exist/emerge. First use of `na-ne-su` and intransitive `be`.

---

**S860 — The law of History, not collective will, is the claimed authority.** *(ANT-002-F)*
...
| Sentence | ID | Key claim | Structural note |
|----------|----|-----------|-----------------|
| S855 | ANT-002-A | The camp is rightlessness | W243 `ka-de-pa`; `ne no-wi-fe` |
| S856 | ANT-002-B | Ideology names; terror destroys | W223 `de-li` reuse; `/` division of labor |
| S857 | ANT-002-C | Movements need masses, not classes | `no-su-o-li` vs `su-o-li`; `ne-fe` |
| S858 | ANT-002-D | Totalitarianism dissolves limits of action | `ka-fe` first use |
| S859 | ANT-002-E | Nation-state decline → stateless persons | `na-ne-su`; intransitive `be` |
| S860 | ANT-002-F | Law of History, not collective will | W245 `ti-go-su`; `wi-o-li` (W238) cross-ref |
| S861 | ANT-002-G | Secret police is the true core | `mi-ne-su`; `u-a-ra-su`; `u-` scope prefix |
| S862 | ANT-002-H | Propaganda signals falsehood, not truth | W224 `ka-si-de` reuse; `no-to` first use |
| S863 | ANT-002-I | Natality resists totalitarianism | W244 `be-ki`; `be lo-X` source frame |
| S864 | ANT-002-J | Politics arises from living bonds | `ne-zo-li` positive first use; `be lo-X` |

**New W-entries:** W243 `ka-de-pa` (concentration camp) · W244 `be-ki` (natality) · W245 `ti-go-su` (historical necessity)

**Reused entries:** W223 `de-li` (S856, first ideological-designation use); W224 `ka-si-de` (S862, first political-propaganda use)
...
| `ne-zo-li` | none | — | 3-morpheme; first positive use; defer |
