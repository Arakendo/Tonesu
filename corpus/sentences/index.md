...
| EMD-002 | Dickinson dash — prosodic suspension mark `—` tested; distinct from `,` `;` `/`; 5 syntactic positions; cross-register (non-poetry); VC-tier `el` (G028) recommended; OQ-VC-001 pending resolution | S514–S523 | s398-plus.md |
