...
| [s398-plus.md](s398-plus.md) | S398+ | *(ongoing)* |
...
| COR-001 | Correction pivot test — `no — Y` adequate for all immediate correction; `/` ≠ correction (symmetry failure, clarifies `/` boundary); `—` is load-bearing juncture making correction a single speech act; `ke` (silent pivot) has marginal gap in multi-exchange; deferred to OQ-COR-001 | S532–S538 | s398-plus.md |
| DEB-001 | Heated debate corpus test — `ke` first qualifying attestation (S545, 1/3): `no —` stale by round 3; `ke` advances without re-performing known denial; `ke!` attested (heated pivot); `ya` productive in adversarial register (S541, S543); `he`+`—`+`!` combined in vocative confrontation (S548); `/` = symmetric framing ≠ correction; OQ-COR-001 pressure 1/3 | S539–S548 | s398-plus.md |
