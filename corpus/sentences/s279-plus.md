...
## Fungi (S???+) *(FNG-001 — pending)*

*Scope: fungi are `zo` (living) but not plant, animal, or acoustic organism. Likely `zo-su-[x]` (structurally-defined living thing) — fungal networks are their defining structure. Short batch. Stress case: mushroom (fruiting body vs organism) parallels `zo-be` (egg vs parent).*

*Pending. Short and isolated; can run at any point after PLT-001 establishes `zo-su-[x]` or alternative plant base.*
