...
- [ ] **Imperative.** No defined structure for direct commands. Candidate: drop `la-tu` (addressee as agent is implied); retain particle-marked arguments and action. `lo-[thing]  ne-[recipient]  ka-[action]`. Needs a grammar rule before imperative corpus sentences can be finalized.
